#!/usr/bin/env python3
"""
Final population script - insert all data directly
"""
...
def populate_final():
    """Populate tables with all data directly"""
    ...
    try:
        ...
        # Insert all interventions with minimal columns
        ...
        for col_name, col_value in additional_columns.items():
            ...
            try:
                ...
                # Clean up test data
                supabase_client.client.table('InterventionsBASE').delete().eq('Intervention_ID', 999).execute()
            except Exception as e:
